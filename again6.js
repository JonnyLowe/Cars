        ...
        function updateModels3() {
            let selectedMakeA = selectBoxA.value;
            let modelsA = modelsByMakeA[selectedMakeA] || []; modelBoxA.innerHTML = "<option>Select</option>";
           
           
            
           // Clear previous options

            modelsA.forEach(function(modelA) {
                let optionA = document.createElement("option");
                optionA.text = modelA;
                optionA.value = modelA;
                modelBoxA.appendChild(optionA);
            });
        }
          ...
          selectBoxA.addEventListener("input", updateModels3);
