        ...
        let selectBoxA = document.getElementById("selectBoxCopy");
        let modelBoxA = document.getElementById("modelsCopy");
        let selectBox1A = document.getElementById("selectBox");
        let modelBox1A = document.getElementById("models");

        // Make Select box copies
        ...
        let modelsByMake1 = {
            ...
            "Renault": ["Captur", "Clio", "Duster", "Kadjar", "Koleos", "Megane", "Scenic", "Twingo", "Zoe"],
            ...
            "Subaru":["BRZ","Forester","Impreza","Levorg","Outback","WRX STI","XV"],
            "Suzuki" :["Alto","Baleno","Celerio","Ignis","Jimny","Swift","SX4 S-Cross","Vitara"],
            "Tesla": ["Model S", "Model 3", "Model X", "Model Y", "Roadster"],
            "Toyota": ["Aygo", "Yaris", "Corolla", "C-HR", "Rav4", "Highlander", "Prius", "Camry", "GT86", "Supra", "Mirai", "Land Cruiser", "Hilux", "Proace City", "Proace Verso", "Proace", "Alphard"],
            "Vauxhall": ["Astra", "Combo", "Combo Life", "Corsa", "Crossland", "Grandland", "Insignia", "Mokka", "Movano", "Vivaro"],
            "Volkswagon": ["Amarok", "Arteon", "Golf", "ID.3", "ID.4", "Passat", "Polo", "Sharan", "Tiguan", "Touareg", "Touran", "T-Roc", "Up!"],
        ...
        function updateModels3() {
            let selectedMake = selectBoxA.value;
            let models1 = modelsByMake1[selectedMake] || [];
        
            // Clear previous options
            modelBoxA.innerHTML = ""; // Clear options before adding new ones
            
            let defaultOption = document.createElement("option");
            defaultOption.text = "Select A Model";
            defaultOption.value = "";
            modelBoxA.appendChild(defaultOption);
        
            models1.forEach(function(model) {
                let option = document.createElement("option");
                option.text = model;
                option.value = model;
                modelBoxA.appendChild(option);
            });
        }

                        // Add event listener to firstSelectBox to update selectBox and models
                selectBoxA.addEventListener('change', function() {
                    // Set the value of selectBox to match selectBox1
                    selectBox1A.value = selectBoxA.value;
                    selectBox1A.innerHTML = selectBoxA.innerHTML;
                    // Call updateModels to update the models based on the selected make
                    updateModels3();
                });
        ...
        selectBoxA.addEventListener("change", function() {
            updateModels3();
            // Trigger change event on modelBoxA to ensure Webflow updates the UI
            if (typeof window.jQuery !== "undefined") {
                $(modelBoxA).trigger("change");
            } else {
                let event = new Event("change");
                modelBoxA.dispatchEvent(event);
            }
        });
        ...
        let selectBox2A = document.getElementById("modelsCopy");
        let modelBox2A = document.getElementById("variantCopy");

        // Create an object with models for each make
        let modelsByVariantA = {
        ...
        /* Mercedes Models To Varients */
                ...
                /* Renault Models To Variants */

                "Captur": ["Iconic", "S Edition", "R.S. Line"],
                "Clio": ["Play", "Iconic", "R.S. Line", "E-TECH Hybrid"],
                "Duster": ["Access", "Essential", "Comfort", "Prestige", "SE Twenty"],
                "Kadjar": ["Iconic", "S Edition", "R.S. Line"],
                "Koleos": ["Iconic", "R.S. Line"],
                "Megane": ["Play", "Iconic", "R.S. Line"],
                "Scenic": ["Play", "Iconic", "R.S. Line"],
                "Twingo": ["Play", "Iconic"],
                "Zoe": ["Play", "Iconic", "GT Line"],

                /* Rolls-Royce Models To Variants */

                "Cullinan": ["Black Badge", "Mansory", "Novitec", "Overfinch"],
                "Dawn": ["Black Badge", "Inspired by Fashion", "Silver Bullet", "Overdose"],
                "Ghost": ["Black Badge", "Elegance", "Eternal Love", "Zenith"],
                "Phantom": ["Extended Wheelbase", "Black Badge", "Serenity", "Tranquility"],
                "Wraith": ["Black Badge", "Eagle VIII", "Inspired by Music", "Overdose"],

                /* SEAT Models To Variants */

                "Alhambra": ["SE", "SE L", "Xcellence", "Xcellence Lux"],
                "Arona": ["SE", "FR", "Xcellence"],
                "Ateca": ["SE", "FR", "Xperience", "Xcellence"],
                "Ibiza": ["SE", "FR", "Xcellence"],
                "Leon": ["SE", "FR", "Xcellence", "CUPRA"],
                "Mii": ["SE", "FR", "Electric"],
                "Tarraco": ["SE", "FR", "Xcellence", "Xperience"],


                /* Skoda Models To Variants */

                "Citigo": ["S", "SE", "SE L"],
                "Enyaq": ["50", "60", "80", "80x", "iV 50", "iV 60", "iV 80", "iV 80x"],
                "Fabia": ["S", "SE", "SE L", "Monte Carlo"],
                "Kamiq": ["SE", "SE L", "Monte Carlo", "SE Drive"],
                "Karoq": ["SE", "SE L", "Edition", "SportLine"],
                "Kodiaq": ["SE", "SE L", "Edition", "Scout", "SportLine", "vRS"],
                "Octavia": ["SE First Edition", "SE Technology", "SE L First Edition"],

                /* Smart Models To Variants */

                "Forfour": ["Passion", "Prime", "Proxy"],
                "Fortwo": ["Passion", "Prime", "Proxy"],
                "Roadster": ["Base", "Brabus"],

                /* Subaru Models To Variants */

                "BRZ": ["SE", "SE Lux", "Limited Edition"],
                "Forester": ["X", "XE", "X-Trail", "XT", "XTi"],
                "Impreza": ["SE", "SE Premium", "SE Nav Plus", "SE Tech Line"],
                "Levorg": ["GT", "GT Plus", "GT Sport", "GT Sport Plus"],
                "Outback": ["SE", "SE Premium", "SE Premium Lineartronic"],
                "WRX STI": ["WRX STI", "WRX STI Type UK", "WRX STI Final Edition"],
                "XV": ["SE", "SE Premium", "SE Premium Lineartronic"],


                /* Suzuki Models To Variants */
                ...
                "Jimny": ["SZ4"],
                "Swift": ["SZ-L", "SZ-T", "SZ5"],
                "SX4 S-Cross": ["SZ4", "SZ-T", "SZ5"],
                "Vitara": ["SZ4", "SZ-T", "SZ5"],

                /* Tesla Models To Variants */

                "Model S": ["Standard Range", "Long Range", "Plaid", "Plaid+"],
                "Model 3": ["Standard Range Plus", "Long Range", "Performance"],
                "Model X": ["Long Range", "Plaid", "Plaid+"],
                "Model Y": ["Standard Range", "Long Range", "Performance"],
                "Roadster": ["Base", "Founder's Series"],

                /* Toyota Models To Variants */

                "Aygo": ["x", "x-play", "x-trend", "x-clusiv"],
                "Yaris": ["Icon", "Design", "Dynamic", "Excel", "GR Sport", "Cross", "Y20", "Y20 Hybrid"],
                "Corolla": ["Icon", "Icon Tech", "Design", "GR Sport", "Trek", "Excel", "Excel Hybrid", "Trek Hybrid", "GR Sport Hybrid"],
                "C-HR": ["Icon", "Design", "Excel", "Dynamic", "GR Sport", "GR Sport Hybrid", "Orange Edition"],
                "Rav4": ["Icon", "Design", "Excel", "Dynamic", "Dynamic Premium", "Black Edition", "GR Sport", "GR Sport Hybrid", "Excel Hybrid"],
                "Highlander": ["Excel", "Excel Hybrid"],
                "Prius": ["Active", "Business Edition Plus", "Excel", "Excel Plus"],
                "Camry": ["Design", "Excel"],
                "GT86": ["GT86", "GT86 Pro", "GT86 Club Series"],
                "Supra": ["3.0", "3.0 Pro", "3.0 A91 Edition", "2.0", "2.0 Pro"],
                "Mirai": ["Mirai"],
                "Land Cruiser": ["Utility", "Active", "Invincible"],
                "Hilux": ["Active", "Icon", "Invincible", "Invincible X"],
                "Proace City": ["Panel Van", "Verso"],
                "Proace Verso": ["Shuttle", "Family", "Family Medium"],
                "Proace": ["Panel Van", "Verso", "Combi", "Shuttle", "Long"],
                "Alphard": ["Standard", "Executive Lounge", "Executive Lounge Plus"],

                /* Vauxhall Models To Variants */

                "Astra": ["SE", "SRi", "SRi Nav", "Elite Nav", "Ultimate Nav", "GSi", "VXR"],
                "Combo": ["Edition", "Sportive", "Limited Edition NAV", "Elite NAV"],
                "Combo Life": ["Design", "Energy", "Edition", "Elite", "Ultimate"],
                "Corsa": ["SE", "SE NAV", "SRi", "SRi NAV", "Elite NAV", "Ultimate NAV", "VXR", "Limited Edition"],
                "Crossland": ["SE", "SE NAV", "SRi NAV", "Elite NAV", "Ultimate NAV"],
                "Grandland": ["SE", "SRi NAV", "Elite NAV", "Ultimate NAV"],
                "Insignia": ["SE Nav", "SRi VX-Line Nav", "Elite Nav", "Ultimate Nav"],
                "Mokka": ["SE", "SRi", "Elite", "Ultimate"],
                "Movano": ["Panel Van", "Doublecab", "Trabus", "Minibus", "Platform Cab"],
                "Vivaro": ["Edition", "Sportive", "Elite", "Elite NAV"],

                /* Volkswagon Models To Variants */

                "Amarok": ["Amarok"],
                "Arteon": ["SE", "Elegance", "R-Line", "R"],
                "Golf": ["Life", "Style", "R-Line", "GTI", "GTI Clubsport", "GTI TCR", "GTD", "GTE", "e-Golf", "R"],
                "ID.3": ["Life", "Family", "Business", "Tech", "Max"],
                "ID.4": ["Life", "Family", "Business", "Tech", "Max"],
                "Passat": ["SE", "SEL", "R-Line", "GTE"],
                "Polo": ["S", "SE", "Beats", "R-Line", "GTI"],
                "Sharan": ["SE Nav", "SEL", "R-Line"],
                "Tiguan": ["Life", "Elegance", "R-Line", "Black Edition"],
                "Touareg": ["SEL", "R-Line", "Black Edition"],
                "Touran": ["S", "SE Family", "SEL", "R-Line"],
                "T-Roc": ["SE", "Design", "R-Line", "R"],
                "Up!": ["Take", "Move", "Beats", "High"],

                /* Volvo Models To Variants */


                "S60": ["Inscription", "Momentum", "Polestar Engineered", "R-Design"],
                "S90": ["Inscription", "Momentum", "R-Design"],
                "V40": ["Cross Country", "Inscription", "Momentum", "R-Design"],
                "V60": ["Cross Country", "Inscription", "Momentum", "Polestar Engineered", "R-Design"],
                "V90": ["Cross Country", "Inscription", "Momentum", "R-Design"],
                "XC40": ["Inscription", "Momentum", "Recharge", "Recharge Inscription", "R-Design"],
                "XC60": ["Inscription", "Momentum", "Polestar Engineered", "Recharge", "Recharge Inscription", "R-Design"],
                "XC90": ["Inscription", "Momentum", "Polestar Engineered", "Recharge", "Recharge Inscription", "R-Design"]

        };

        // Function to update models based on selected make
        function updateModels4() {
            let selectedMakeA = selectBox2A.value;
            let modelsA = modelsByVariantA[selectedMakeA] || []; modelBox2A.innerHTML = "<option>Select</option>";
           
           
            
           // Clear previous options

            modelsA.forEach(function(model) {
                let option = document.createElement("option");
                option.text = model;
                option.value = model;
                modelBox2A.appendChild(option);
            });
        }

                // Add event listener to firstSelectBox to update selectBox and models
                modelBoxA.addEventListener('change', function() {
                    // Set the value of selectBox to match selectBox1
                    modelBox1A.value = modelBoxA.value;
                    modelBox1A.innerHTML = modelBoxA.innerHTML
                    // Call updateModels to update the models based on the selected make
                    updateModels4();
                });

        // Add event listener to call updateModels when select box changes
        selectBox2A.addEventListener("change", updateModels4);
        selectBoxA.addEventListener("change", updateModels4); 
