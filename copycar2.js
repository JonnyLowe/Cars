...
let selectBox = document.getElementById("firstSelectBox");
let modelBox = document.getElementById("firstModelBox");
let selectBox1 = document.getElementById("selectBox");
let firstModelBox = document.getElementById("models")
// Make Select box copies


// Get references to both select boxes
...
function updateModels3() {
   ...
   // Clear previous options
    ...
    models.forEach(function(model) {
        ...
        firstModelBox.appendChild(option);
    });
}
...
selectBox1.addEventListener('change', function() {
  ...
  selectBox.value = selectBox1.value;
...
selectBox.addEventListener("input", updateModels3);
...
let selectBox2 = document.getElementById("firstModelBox");
...
// Add event listener to call updateModels when select box changes
firstModelBox.addEventListener('change', function() {
    // Set the value of selectBox to match selectBox1
    modelBox.value = firstModelBox.value;
    // Call updateModels to update the models based on the selected make
    updateModels4();
});
