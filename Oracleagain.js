        ...
        let selectBoxs = document.getElementById("form-field-selectBox");
        let modelBoxs = document.getElementById("form-field-models");
        ...
        function updateModels3() {
            let selectedMake = selectBoxs.value;
            let models = modelsByMake[selectedMake] || []; modelBoxs.innerHTML = "<option>Select</option>";
        ...
        let selectBox2 = document.getElementById("form-field-models");
        let modelBox2 = document.getElementById("form-field-variant");
        ...
        selectBoxs.addEventListener("change", updateModels1); 
