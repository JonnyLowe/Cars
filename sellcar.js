        ...
        let modelsByMake1 = {
            ...
            "Volkswagen": ["Amarok", "Arteon", "Golf", "ID.3", "ID.4", "Passat", "Polo", "Sharan", "Tiguan", "Touareg", "Touran", "T-Roc", "Up!"],
        ...
        let selectBox4 = document.getElementById("model_1");
        let modelBox4 = document.getElementById("variant_1");
        ...
        function updateModels4() {
            ...
            let models4 = modelsByVariant1[selectedMake4] || []; modelBox4.innerHTML = "<option></option>";
