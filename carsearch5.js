        ...
        let selectBox3 = document.getElementById("make");
        let modelBox3 = document.getElementById("model");
        ...
        function updateModels3() {
            let selectedMake3 = selectBox.value;
            let models3 = modelsByMake1[selectedMake3] || []; modelBox.innerHTML = "<option>Select</option>";
           
           
            
           // Clear previous options

            models3.forEach(function(model) {
          ...
          selectBox3.addEventListener("input", updateModels3);
        ...
        let selectBox4 = document.getElementById("model");
        let modelBox4 = document.getElementById("variant");

        // Create an object with models for each make
        let modelsByVariant1 = {
        ...
        /* Mercedes Models To Varients */
                ...
                "Corsa": ["Active","SE", "SE NAV", "SRi", "SRi NAV", "Elite NAV", "Ultimate NAV", "VXR", "Limited Edition"],
        ...
        function updateModels4() {
            let selectedMake4 = selectBox2.value;
            let models4 = modelsByVariant1[selectedMake4] || []; modelBox2.innerHTML = "<option>Select</option>";
           
           
            
           // Clear previous options

            models4.forEach(function(model) {
                let option = document.createElement("option");
                option.text = model;
                option.value = model;
                modelBox4.appendChild(option);
            });
        }

        // Add event listener to call updateModels when select box changes
       
        selectBox3.addEventListener("change", updateModels4); 
        selectBox4.addEventListener("change", updateModels4);
